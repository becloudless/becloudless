{ config, lib, pkgs, ... }:
{
  config = lib.mkMerge [
    ...
    systemd.services."data" = {
      ...
      script = ''
        mkdir -p /data
        ${pkgs.sshfs-fuse}/bin/sshfs -f -o allow_other,reconnect,ServerAliveInterval=15,ServerAliveCountMax=3 media.lmr.fr:/ /data
      '';
    ...
    programs.ssh = {
      ...
      '';
      knownHosts = {
        "media.lmr.fr".publicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHxQyNqTdKQwVwp4mNGuYpodwZrftyug5JMwgGAsZ74N";
      };
    };
  };
}
