...
//go:generate ./dist-tools/go-jsonschema -p schema --schema-root-type global=Global ../nixos/modules/nixos/bcl/global.schema.json -o pkg/generated/schema/schema.go
func main() {
